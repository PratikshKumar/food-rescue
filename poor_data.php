...
//]]>
        ...
        <div style="  background: linear-gradient(180deg, #0ccda3 10%, #C1FCD3 100%) ; padding-top:40px; margin-top:0" >
        <nav>
  <div class="menu">
    <div class="container">
      <ul class="inner-menu">
        ...
        <h2 style="color:darkblue; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; margin-left:34%; margin-bottom:20px" >ANALYSIS OF NEEDY PEOPLE</h2>
        <section id="donation" class="donationbg top" style="background: linear-gradient(180deg, #0ccda3 10%, #C1FCD3 100%);">
        <div>
    <table>
      <div >
        <tr>
        ...
        <div class="row top60  bottom60">
          ...
          <div class="col-md-8 col-sm-10">
            <div class="intro-text center wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"> <span class="heading-title bottom25">Food Donation</span> 
              <h2 class=" bottom25 " style="font-weight:bolder;font-size:xx-large">Facts  Sheet</h2>
            </div>
          </div>
          <div class="col-md-2 col-sm-1"></div>
          <div class="row circular-wrap text-center">
            <div class="col-md-4 col-sm-4 top50 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
              <div id="circle" class="circle" data-value="0.77"><canvas width="262" height="262" style="height: 10px; width: 210px;"></canvas> <strong style="color:black; font-weight:900">53+</strong> </div>
              <h4 class="darkcolor top50 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp; color:black; font-weight:900" > Places</h4>
            </div>
            <div class="col-md-4 col-sm-4 top30">
              <div id="circletwo" class="circle" data-value="0.96"><canvas width="262" height="262" style="height: 10px; width: 210px;"></canvas> <strong  style="color:black; font-weight:900">250+</strong> </div>
              <h4 class="darkcolor top50 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp; color:black; font-weight:900">Volunteers</h4>
            </div>
            <div class="col-md-4 col-sm-4 top50 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
              <div id="circlethree" class="circle" data-value="0.75"><canvas width="262" height="262" style="height: 10px; width: 210px;"></canvas> <strong  style="color:black; font-weight:900">1 Million+</strong> </div>             
              <h4 class="darkcolor top50" style="color:black; font-weight:900"> People Benefited</h4>
            </div>
          </div>
        </div>
      </div> 
