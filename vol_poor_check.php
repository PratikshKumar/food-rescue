...
<style>
.carousell-container {
  background: linear-gradient(90deg, #0ccda3 40%, #C1FCD3 65%);
  padding: 20px;
  width: 100%;
  max-width: 1000px;
  margin: 0 auto;
...
.carousell {
  display: flex;
  width: 100%;
  animation: carousellAnimation 24s infinite;
}
...
/* Add a style for the border between left and right sections */
.big-box .team-member:before {
  content: "";
  display: block;
  width: 1px;
    ...
    <div class="container">
      ...
      <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel"> 
        ...
        <div class="carousel-inner"> 
            ...
            <!-- Slide 4 -->
          <div class="item"> <img src="./images/bhookh1.jpg" style="width:100%; border-radius: 20px; background-color: black; filter: blur(4px);
  -webkit-filter: blur(4px); " alt="">
            <div class="carousel-caption">
            <h1 style=" background-color: rgb(0,0,0); /* Fallback color */
  background-color: rgba(0,0,0, 0.4); /* Black w/opacity/see-through */
  color: white;
  ">Blooming Smiles by Facilitating Surplus Food Donations <span>Since 2022</span> </h1>
            </div>
          ...
          <!-- /Slide4 --> 
          <!-- Slide 1 : Active -->
          <div class="item active"> <img src="./images/bhookh2.jpg" style="width:100%; border-radius: 20px; background-color: black; filter: blur(4px);
  -webkit-filter: blur(4px);" alt="">
            <div class="carousel-caption">
              <h1 style=" background-color: rgb(0,0,0); /* Fallback color */
  background-color: rgba(0,0,0, 0.4); /* Black w/opacity/see-through */
  color: white;
  ">Hunger is a crisis that has almost a billion
people in its grip <span></span> </h1>
          ...
          <!-- /Slide1 --> 
          <!-- Slide 2 -->
          <div class="item"> <img src="./images/bhookh3.jpg" style="width:100%; border-radius: 20px; background-color: black; filter: blur(4px);
  -webkit-filter: blur(4px);" alt="">
            <div class="carousel-caption">
              <h1 style=" background-color: rgb(0,0,0); /* Fallback color */
  background-color: rgba(0,0,0, 0.4); /* Black w/opacity/see-through */
  color: white;
  "> <span></span> Hunger is more than missing a meal.</h1>
          ...
          <!-- Slide 3 -->
          <div class="item"> <img src="./images/bhookh4.jpg" style="width:100%; border-radius: 20px; background-color: black; filter: blur(4px);
  -webkit-filter: blur(4px);" alt="">
            <div class="carousel-caption">
              <h1 style=" background-color: rgb(0,0,0); /* Fallback color */
  background-color: rgba(0,0,0, 0.4); /* Black w/opacity/see-through */
  color: white;
  ">Don’t let <span>surplus</span> food go to waste. Every thirteen seconds, a child dies from the effects of hunger.</h1>
        ...
        <div class="row">
          <div class="col-md-10 col-sm-push-1">
            <div class="intro-text center wow fadeInUp top60 bottom60" style="visibility: visible; animation-name: fadeInUp;"> <span class="heading-title bottom25">Welcome</span>
              <h2 class="bottom15" style="color:black; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Welcome <span class="defaultcolor" style="color:crimson"> food rescue</span> website! <br> <br>
              Welcome, <span class="defaultcolor" style="color:crimson" > volunteers!</span>  Thank you for your interest in helping to distribute food to those in need.
               This website serves as a platform to connect volunteers with organizations in your local area that are distributing food to the poor.
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 col-sm-6 text-right" style="color:brown; font-weight: 900; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
            <div class="intro-text wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;"> <span class="heading-title bottom15" style="color: brown;"> The Beginning</span>
              <h2 class="darkcolor">Our Approach</h2>
              <p class="darkcolor" >
                <h2 class="bottom15 ">
                Through this website, you can easily search for organizations that need volunteers to help distribute food, and find contact information for the organizations that you are interested in helping.
                <br><br>
                <!-- To use this platform, simply log in with your credentials and browse through the list of organizations in your area. You can filter your search based on your location and organizations you are interested in volunteering with. -->
                <br><br>
                <!--  -->
                We hope that this platform will make it easier for you to find and connect with organizations that are making a difference in your community. Together, we can work towards ending hunger and ensuring that everyone has access to the food they need.
                <br><br>
                <!-- Thank you for your dedication to this important cause, and for joining us in the fight against hunger. -->
  ...
  <input  type="submit" value="CHECK THE NEEDY AREAS HERE" style=" border-radius:35px; width:370px; margin-top:5px; background-color:#ff9b; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color:darkred; font-size:x-large">
...
<br>
    <div class="col-md col-sm">
            <div class="intro-text center wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"> <span class="heading-title darkcolor " style="color:aliceblue; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-weight:bold">Our Volunteers - The Backbone </span>
              ...
              <form method="post" action="./food_av2.php">
    <input class="btn btn-primary" type="submit" value="Show total food available" style=" border-radius:35px; width:370px; margin-top:5px; background-color:#ff9b; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color:darkred; font-size:x-large" name="city">
     ...
     <!-- <a href="add_poor.php">
      <input class="btn btn-primary" type="submit" value="Add Poor Location" style=" border-radius:35px; width:370px; margin-top:5px; background-color:#ff9b; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color:darkred; font-size:x-large" name="city">
      </a>  -->
...
<div class="carousell-container" >
        <div class="carousell" >
          ...
          <div class="slidePk" >
            <div class="big-box" >
              <div class="team-member">
                <div class="photopk">
                  <img src="./pb2.jpg" alt="Team Member 1">
                </div>
                <div class="infopk" style="display: flex;" >
                  <div class="textpk">
                    <h2><b>Pratham Bhatia</b></h2>
                    <br> 
                    <b><h3>Team Leader</h3></b>
                    
                  </div>
                  <div class="textpk" style="margin-left: 20px;">
                    <p>Contribution: </p> 
                    <p>* Implemented Security and Authentication </p>
                    <p>* Overall project management and coordination. </p>
                       <p>* Design and architecture of the application. </p>
                       <p>* Implemented core functionality and critical features. </p>
                       <p>* Conducted code reviews and ensured coding standards. </p>
                        * Provided guidance and support to other team members.
                  </div>
          ...
          <!-- Repeat the slidePk structure for other team members -->
          ...
          <div class="slidePk">
            <div class="big-box">
              <div class="team-member">
                <div class="photopk">
                  <img src="./rkb.jpg" alt="Team Member 1">
                </div>
                <div class="infopk" style="display: flex;" >
                  <div class="textpk">
                    
                    <h2><b>Rohan Kumar</b></h2>
                    <br> 
                    <b><h3>Backend Developer</h3></b>
                    
                  </div>
                  <div class="textpk" style="margin-left: 20px;">
                    <p>Contribution: </p>
                    <p>* Designed and developed the database schema. </p>
                    <p>* Implemented core backend functionality.</p>
                       <p>* Implemented data access and storage using SQL queries. </p>
                       <p>* Implemented core functionality and critical features. </p>
                       
                       <p>* Optimized backend code for performance and scalability.</p>
                        <!-- Provided guidance and support to other team members. -->
                  </div>
          ...
          <div class="slidePk">
            <div class="big-box">
              <div class="team-member">
                <div class="photopk">
                  <img src="./pk.jpg" alt="Team Member 1">
                </div>
                <div class="infopk" style="display: flex;" >
                  <div class="textpk">
                    ...
                    <h2><b>Pratiksh</b></h2>
                    <br> 
                    <b><h3>Frontend and</h3></b>
                    <b><h3> Backend Developer</h3></b>
                    
                  </div>
                  <div class="textpk" style="margin-left: 20px;">
                    <p>Contribution: </p> 
                    <p>* Implemented frontend and backend integration.</p>
                       <p>* Collaborated with backend developers to display data </p>
                       <p>* Assisted in debugging & resolving backend issues. </p>
                       <p>* Developed specific backend modules. </p>
                       <p>* Assisted with backend development tasks as needed.</p>
                       <!-- <p>* Ensured coding standards. </p> -->
          ...
          <div class="slidePk">
            <div class="big-box">
              <div class="team-member">
                <div class="photopk">
                  <img src="./gv2.jpg" alt="Team Member 1">
                </div>
                <div class="infopk" style="display: flex;" >
                  <div class="textpk">
                  
                    <h2><b>Girisha Vashisht</b></h2>
                    <br> 
                    <b><h3>FrontEnd Developer</h3></b>
                    
                  </div>
                  <div class="textpk" style="margin-left: 20px;">
                    <p>Contribution: </p> 
                    <p>* Developed the user interface and responsive design </p>
                       <!-- <p>* Implemented responsive design </p> -->
                      <p>* Ensured cross-browser compatibility.</p>
                       <p>* Handled user input validation and form submissions. </p>
                       <p>* Conducted testing related to the frontend. </p>
                       <p>* Prepared technical documentation for the project.</p>
                       <!-- <p>* Collaborated with team to ensure documentation accuracy.</p> -->
                        <!-- Provided guidance and support to other team members. -->
                  </div>
          ...
          <div class="slidePk">
            <div class="big-box">
              <div class="team-member">
                <div class="photopk">
                  <img src="./vg.jpg" alt="Team Member 1">
                </div>
                <div class="infopk" style="display: flex;" >
                  <div class="textpk">
                    
                    
                    <h2><b>Vanshika Garg</b></h3>
                    <br> 
                    <b><h3>Quality Assurance</h3></b>
                    <h3>Tester</h3></b>
                    
                  </div>
                  <div class="textpk" style="margin-left: 20px;">
                    <p>Contribution: </p> 
                    <p>* Performed system testing and usability testing. </p>
                       <p>* Collaborated with the QA team for bug tracking.</p>
                       <p>* Performed functional testing of the application.</p>
                       <!-- <p>* Collaborated with the backend and frontend teams to ensure overall quality. </p> -->
                       <p>* Maintained project documentation and version control.</p>
                       <p>* Assisted with other tasks related to project documentation.</p>
                        <!-- Provided guidance and support to other team members. -->
                  </div>
